<template>
  <div class="w-screen h-screen flex">
    <!-- Side bar -->
    <div class="w-[500px] h-full bg-[#FFEFD5] text-black" v-show="showSide">
        ...
        <div class="border border-gray-300 rounded-md p-[20px] h-full">
          ...
          <div>
            <select
              v-model="search"
              id="countries"
              class="w-72 bg-gray-50 border border-gray-500 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-100 dark:border-gray-900 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500"
            >
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200" align="left">
                <tr v-for="donasi in filteredSearch" :key="donasi.id_donasi">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900">
                      <a class="text-teal-500" :href="donasi.bukti">Bukti</a>
                    </div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center space-x-2">
                      <button
                        ...
                        v-if="donasi.status_donasi == 'diterima'"
                        @click="
                          verifikasi(
                            donasi.id_donasi,
                            donasi.id_artikel,
                      ...
                      <div
                        ...
                        v-if="donasi.status_donasi == 'terverifikasi'"
                      >
                        Sudah Terverifikasi
                      </div>
                    </div>
...
export default {
  ...
  methods: {
    verifikasi(value1, value2, jumlah) {
      axios
        .put("donasi/" + value1, {
          status_donasi: "terverifikasi",
        })
        .then(() => {
          axios
            .put("artikel/tambah_donasi/" + value2, {
              total_donasi: jumlah,
            })
            .then(() => {
        ...
        .catch((error) => {
          alert("donasi gagal diverifikasi");
          location.reload();
          console.log(error.response.data);
        });
    },
    ...
    filteredSearch() {
      if (this.data) {
        return this.data.filter((donasi) =>
          donasi.id_artikel.toLowerCase().includes(this.search.toLowerCase())
        );
      } else {
        return [];
      }
